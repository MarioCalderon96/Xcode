...
var donuts = ["sprinkled", "chocolate", "caramel", "jelly Filled", "Sugar", "Galzed"]

var numberOfDonuts: [Int] = [10, 15, 12, 14, 8, 20]

donuts.remove(at: 5)
numberOfDonuts.remove(at: 5)

donuts.insert("Bacon", at: 0)
numberOfDonuts.insert(0, at: 0)

donuts.removeAll()
numberOfDonuts.removeAll()
